...
This experimental fork removes some things that are probably very helpful.

You should use the original [ryansonshine/typescript-npm-package-template](https://github.com/ryansonshine/typescript-npm-package-template)
